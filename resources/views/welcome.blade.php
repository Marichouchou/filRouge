        ...
        <nav class="navbar navbar-default navbar-fixed-top fadeInDown" data-wow-delay="0.5s">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="pull-right text-right">
                            <ul class="list-inline">
                                <li>
                                    <div><i class="fa fa-envelope-o"></i> mariamadaou96@gmail.com</div>
                                </li>
                                <li>
                                    <div class="meta-item"><i class="fa fa-mobile"></i> +223 75078707</div>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <!-- <a class="navbar-brand smoothie logo logo-light" href="index.html"><img src="public/assets/img/logo.png" alt="logo"></a> -->
                    <a class="navbar-brand smoothie logo logo-dark" href="index.html"><img src="public/assets/img/logo1.png" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">ListeAgences <span class="pe-7s-angle-down"></span></a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Agences</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="index-agency-1.html">SidibeImmobilier</a></li>
                                        <li><a href="index-agency-2.html">DialloImmobilier</a></li>
                                        <li><a href="index-agency-3.html">BkoImmobilier</a></li>
                                    </ul>
                                </li>
                                <!-- <li class="dropdown-submenu">
                        ...
                        <li class="dropdown">
                            <a href="{{route('register')}}">S'inscrire <span class="pe-7s-angle-down"></span></a>
        ...
        <header id="headerwrap" class="dark-wrapper backstretched special-max-height no-overlay">
            <div class="container vertical-center">
                <div class="intro-text vertical-center text-left smoothie">
                    <div class="intro-heading wow fadeIn heading-font" data-wow-delay="0.2s">Voici SOUDOU BABA</div>
                    <div class="intro-sub-heading wow fadeIn secondary-font" data-wow-delay="0.4s">Utiliser notre plateforme <span class="rotate">pour la visibilter de vos biens d'une part et la faciliter des recherches d'autre part</span></div>
                </div>
            </div>
        </header>
                        ...
                        <ul class="masonry-portfolio-items isotope list-unstyled">
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    <img src="assets/img/homepages/agency-1.jpg" class="img-responsive smoothie" alt="">
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    <img src="assets/img/homepages/blog-2.jpg" class="img-responsive smoothie" alt="">
                                    <div class="overlay-item-caption smoothie"></div>
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    <img src="assets/img/homepages/corporate-1.jpg" class="img-responsive smoothie" alt="">
                                    <div class="overlay-item-caption smoothie"></div>
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    <img src="assets/img/homepages/landing-2.jpg" class="img-responsive smoothie" alt="">
                                    <div class="overlay-item-caption smoothie"></div>
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    <img src="assets/img/homepages/portfolio-1.jpg" class="img-responsive smoothie" alt="">
                                    <div class="overlay-item-caption smoothie"></div>
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
