...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Inscription_Secretaire') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('secretaire.create') }}">
                        @csrf

                        <div class="row mb-3">
                            <label for="nom" class="col-md-4 col-form-label text-md-end">{{ __('Nom_secretaire') }}</label>
