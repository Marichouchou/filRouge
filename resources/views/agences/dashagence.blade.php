            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Attente</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Locations</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Paiements</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Attentes2</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Visites </span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="form-basic.html" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> Rendez-vous </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="form-wizard.html" class="sidebar-link"
                      ><i class="mdi mdi-note-plus"></i
                      ><span class="hide-menu">Liste_Visites </span></a
                    >
                  </li>
                </ul>
              </li>
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="/secretaires" class="sidebar-link"
                      ><i class="mdi mdi-emoticon"></i
                      ><span class="hide-menu"> Secretaire </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="/comptables" class="sidebar-link"
                      ><i class="mdi mdi-emoticon-cool"></i
                      ><span class="hide-menu"> Comptable </span></a
                    >
                  </li>
                </ul>
              </li>
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Biens </span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="index2.html" class="sidebar-link"
                      ><i class="mdi mdi-view-dashboard"></i
                      ><span class="hide-menu"> Ajouter_Biens </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="pages-gallery.html" class="sidebar-link"
                      ><i class="mdi mdi-multiplication-box"></i
                      ><span class="hide-menu"> Liste_Biens </span></a
                    >
                  </li>
                  <li class="sidebar-item">
